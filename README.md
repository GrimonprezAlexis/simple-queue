# Set Up Message Queues for Async Tasks with RabbitMQ in Nest.js Apps
...
## Usage
- RabbitMQ dashboard to view queue activity on http://localhost:15672 <br>
By default the user is `guest`, for the username and password.
